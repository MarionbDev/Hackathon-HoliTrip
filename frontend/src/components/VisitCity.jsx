  ...
  return (
    <div>
      <div className="grid grid-cols-3 gap-4 grid-flow-row grid-">
        <figure className="p-5 text-center bg-white row-start-1 row-end-4">
          <img src={visit.preview.source} alt={visit.name} />
        </figure>
        <figcaption>
          <h2 className="title p-5 text-center bg-white col-start-2 col-end-4 row-start-1 row-end-2">
            {visit.name} {visit.address.city}
          </h2>
          <p className="p-5 text-center bg-white col-start-2 col-end-4 row-start-2 row-end-4">
